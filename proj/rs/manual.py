...
def main():
    ...
    db = condb("127.0.0.1", 9927, "myrs", "rsdb")
    # db = condb("172.16.201.189", 9927, "myrs", "rsdb")
    # write()

    initNode("127.0.0.1", "root", "www.1.com", "ws://127.0.0.1:8516", "/data/ethdata/node1/keystore")
...
if __name__ == '__main__':
    ...
    initNode("127.0.0.1", "root", "root", "ws://127.0.0.1:8516", "/data/ethdata/node1/keystore")
    w3, curBlk = pickNode()
    contract = getContract('./RS.json')

    for i in range(1, w3.eth.blockNumber + 1):
        blk = w3.eth.getBlock(i)
        tx = Web3.toHex(blk.transactions[0])
        print(tx)
        txsync(tx)

    #txsync('0xc8122686c5a488aaae3ba647c4ae93ebadd3f74d9b7c2b1f7fead06b94f22cf7') 
